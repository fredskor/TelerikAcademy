...
class BasketBattle
{
    static void Main()
    {
        ...
        int triesPointsFirstPlayer = 0;
        string resultFirstPlayer;
        int triesPointsSecondPlayer = 0;
        ...
        for (int i = 0; i < numberOfRounds; i++)
        {
            if ((i % 2 == 1 || i == 1) && i > 0)
            {
                triesPointsSecondPlayer = int.Parse(Console.ReadLine());
                resultSecondPlayer = Console.ReadLine();
                triesPointsFirstPlayer = int.Parse(Console.ReadLine());
            ...
            {
                pointsFirstPLayer += triesPointsFirstPlayer;
            }
            if (resultSecondPlayer == "success")
            {
                pointsSecondPLayer += triesPointsSecondPlayer;
            }
            if (pointsFirstPLayer > 500)
            {
                pointsFirstPLayer = pointsFirstPLayer - triesPointsFirstPlayer;
            }
            if (pointsSecondPLayer > 500)
            {
                pointsSecondPLayer = pointsSecondPLayer - triesPointsSecondPlayer;
            }
